...
**構成エリア**:
- サイドバー: グローバルナビゲーション（閉状態：最上部にアプリロゴアイコン＋ナビアイコン。ホバー時にオーバーレイで展開しアプリロゴ＋アプリ名を表示）
- 機能グリッドエリア: 3列×2行のグリッドレイアウトで主要機能（検査処理設定・画像管理・学習管理・検査処理分析・検査稼働・クラウド）へのアイコン付きボタンを配置
